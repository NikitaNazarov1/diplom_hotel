...
Based on Rails 4.1.1 routes of RubyHotel::Application
 */
...
(function() {
  ...
  Utils = {
    ...
    make: function() {
      var routes;
      routes = {
// available_arrival_dates_room_category => /room_categories/:id/available_arrival_dates(.:format)
  // function(id, options)
  available_arrival_dates_room_category_path: Utils.route([["id",true],["format",false]], {}, [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"room_categories",false]],[7,"/",false]],[3,"id",false]],[7,"/",false]],[6,"available_arrival_dates",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// available_departure_dates_room_category => /room_categories/:id/available_departure_dates(.:format)
  // function(id, options)
  available_departure_dates_room_category_path: Utils.route([["id",true],["format",false]], {}, [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"room_categories",false]],[7,"/",false]],[3,"id",false]],[7,"/",false]],[6,"available_departure_dates",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// dbreset => /dbreset(.:format)
  // function(options)
  dbreset_path: Utils.route([["format",false]], {}, [2,[2,[7,"/",false],[6,"dbreset",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// new_reservation => /reservations/new(.:format)
  // function(options)
  new_reservation_path: Utils.route([["format",false]], {}, [2,[2,[2,[2,[7,"/",false],[6,"reservations",false]],[7,"/",false]],[6,"new",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// rails_info => /rails/info(.:format)
  // function(options)
  rails_info_path: Utils.route([["format",false]], {}, [2,[2,[2,[2,[7,"/",false],[6,"rails",false]],[7,"/",false]],[6,"info",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// rails_info_properties => /rails/info/properties(.:format)
  // function(options)
  rails_info_properties_path: Utils.route([["format",false]], {}, [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"rails",false]],[7,"/",false]],[6,"info",false]],[7,"/",false]],[6,"properties",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// rails_info_routes => /rails/info/routes(.:format)
  // function(options)
  rails_info_routes_path: Utils.route([["format",false]], {}, [2,[2,[2,[2,[2,[2,[7,"/",false],[6,"rails",false]],[7,"/",false]],[6,"info",false]],[7,"/",false]],[6,"routes",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// rails_mailers => /rails/mailers(.:format)
  // function(options)
  rails_mailers_path: Utils.route([["format",false]], {}, [2,[2,[2,[2,[7,"/",false],[6,"rails",false]],[7,"/",false]],[6,"mailers",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// reservation => /reservations/:id(.:format)
  // function(id, options)
  reservation_path: Utils.route([["id",true],["format",false]], {}, [2,[2,[2,[2,[7,"/",false],[6,"reservations",false]],[7,"/",false]],[3,"id",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// reservations => /reservations(.:format)
  // function(options)
  reservations_path: Utils.route([["format",false]], {}, [2,[2,[7,"/",false],[6,"reservations",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// room_categories => /room_categories(.:format)
  // function(options)
  room_categories_path: Utils.route([["format",false]], {}, [2,[2,[7,"/",false],[6,"room_categories",false]],[1,[2,[8,".",false],[3,"format",false]],false]]),
// root => /
  // function(options)
...
(function() {
  $(document).on('ready page:load  turbolinks:load', function() {
    var $category_id, departureDatePicker, updateDepartureDates;
    if ($('body.accommodations').filter('.new, .create').length) {
      ...
      updateDepartureDates = function() {
        return departureDatePicker.update($category_id.val(), Date.create('today'));
      };
      updateDepartureDates();
      return $category_id.change(updateDepartureDates);
    }
  });

}).call(this);
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/shared/accommodations.map
;
(function() {
  var Datepicker,
    slice = [].slice,
  ...
  Datepicker = (function() {
    function Datepicker(field) {
      ...
      this._$datepicker = $("div.datepicker." + field);
      input_class = "input." + field;
      $input = $(input_class);
      this._datepicker({
        altField: input_class,
        defaultDate: $input.val(),
        beforeShowDay: this._canSelect([])
      });
    }
    ...
    Datepicker.prototype.change = function(callback) {
      return this._datepicker('option', 'onSelect', callback);
    };

    Datepicker.prototype._datepicker = function() {
      var args, ref;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return (ref = this._$datepicker).datepicker.apply(ref, args);
    };

    Datepicker.prototype._setDates = function(dates) {
      if (dates == null) {
        dates = null;
      }
      return this._datepicker('option', 'beforeShowDay', this._canSelect(dates));
    };

    Datepicker.prototype._updateDates = function(url) {
      if (url == null) {
        url = null;
      }
      ...
      if (url == null) {
        return this._setDates();
      } else {
        return this._request = $.getJSON(url, (function(_this) {
          return function(dates) {
            return _this._setDates(dates);
          };
        })(this));
      }
    };

    Datepicker.prototype._canSelect = function(dates) {
      var range;
      if (dates == null) {
        dates = null;
      }
      if ((dates != null) && (dates.range_begin != null) && (dates.range_begin != null)) {
        range = Date.range(Date.create(dates.range_begin), Date.create(dates.range_end));
        return function(date) {
          var ref;
          if (!range.contains(date)) {
            return [false];
          } else if ((ref = dates.available_dates) != null ? ref.none(date.format('{yyyy}-{MM}-{dd}')) : void 0) {
            return [false, 'datepicker-no-free-rooms', 'нет свободных номеров'];
          } else {
            return [true];
          }
        };
  ...
  this.ArrivalDatepicker = (function(superClass) {
    extend(ArrivalDatepicker, superClass);

    function ArrivalDatepicker() {
      return ArrivalDatepicker.__super__.constructor.apply(this, arguments);
    }

    ArrivalDatepicker.prototype.update = function(category_id) {
      var url;
      url = category_id ? Routes.available_arrival_dates_room_category_path(category_id) : void 0;
      return this._updateDates(url);
    };
  ...
  this.DepartureDatepicker = (function(superClass) {
    extend(DepartureDatepicker, superClass);

    function DepartureDatepicker() {
      return DepartureDatepicker.__super__.constructor.apply(this, arguments);
    }

    DepartureDatepicker.prototype.update = function(category_id, arrival) {
      var url;
      url = category_id && arrival ? Routes.available_departure_dates_room_category_path(category_id, {
        arrival: arrival
      }) : void 0;
      return this._updateDates(url);
    };
...
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/shared/arrival_departure_datepicker.map
;
(function() {
  $.fn.twitter_bootstrap_confirmbox.defaults = {
    ...
    proceed: 'Да',
    proceed_class: 'btn btn-danger proceed',
    cancel: 'Отмена',
    cancel_class: 'btn cancel'
  };

}).call(this);
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/shared/confirm.map
;
(function() {
...
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/shared/datepicker.map
;
(function() {
  $(document).on('ready page:load turbolinks:load', function() {
    var $category_id, arrivalDatePicker, departureDatePicker, updateArrivalDates, updateDepartureDates;
    if ($('body.reservations').filter('.new, .create').length) {
      ...
      updateArrivalDates = function() {
        return arrivalDatePicker.update($category_id.val());
      };
      updateArrivalDates();
      $category_id.change(updateArrivalDates);
      updateDepartureDates = function() {
        return departureDatePicker.update($category_id.val(), arrivalDatePicker.date());
      };
      updateDepartureDates();
...
//# sourceMappingURL=/assets/source_maps/app/assets/javascripts/shared/reservations.map
;
